...
![img](http://blogimg.hongjy.cn/1.png)官网首页
...
![img](http://blogimg.hongjy.cn/1-163678809791627.png)严格模式
...
![img](http://blogimg.hongjy.cn/1-163678809791628.jpeg)文本编辑设置
...
![img](https://cdn.sspai.com/2019/05/24/1PgjVML79GYGHbGHPbCgWAK4xNj5FPb4Hw.png?imageView2/2/w/1120/q/90/interlace/1/ignore-error/1)复制图片

你也完全可以使用图床来保证文档在分享后图片仍能正常显示。

更强大的是，Typora 支持在拖动或 `Ctrl + V` 网络图片后自动将其保存到本地。你可以在 `文件 - 偏好设置 - 编辑器 - 图片插入` 中选择复制到哪个路径，什么情况下需要复制。

![img](http://blogimg.hongjy.cn/1-163678809791730.png)图片插入
...
![img](http://blogimg.hongjy.cn/8b4e14ef732a23d4cc2a8fb1f8ec016c.gif)两种模式
...
![img](http://blogimg.hongjy.cn/f99c9ce02e2728ec6c64b443947fc67e.gif)所见即所得

为了防止一些程序 bug 的发生（虽然在我使用下来感到是很少的）导致格式问题无法修改，Typora 保留了一个**「源代码模式」**。你可以通过 `视图 - 源代码模式` 或左下角的 `</>` 按钮进入。

![img](http://blogimg.hongjy.cn/bcda9c4e35725b7297a6b90d8745564e.gif)源代码模式

#### 大纲 / 文件侧边栏

![img](http://blogimg.hongjy.cn/1-163678809791731.png)侧边栏
...
![img](http://blogimg.hongjy.cn/1-163678809791732.png)空格、换行、换段
...
![img](http://blogimg.hongjy.cn/1-163678809791833.png)输入法联想

在 Typora 中，你可以用 `:emoji:` 的形式来打出 emoji，软件会自动给出图形的提示，还是比较好用的。

![img](http://blogimg.hongjy.cn/1-163678809791834.png)Typora 中输入 emoji
...
![img](http://blogimg.hongjy.cn/1-163678809791835.png)代码块
...
![img](http://blogimg.hongjy.cn/1-163678809791836.png)Typora 表格
...
![img](http://blogimg.hongjy.cn/1-163678809791837.png)链接引用和脚注
...
![img](http://blogimg.hongjy.cn/1-163678809791838.png)导出

## 一个伪装成文本编辑器的浏览器

当我的一个朋友问我「Typora 有什么好写的？」时，我回答「Typora 是一个伪装成文本编辑器的浏览器」。是的，事实上如果你有一定的计算机基础，你可以找到许多有关于「Typora 其实是一个浏览器」的蛛丝马迹。

![img](http://blogimg.hongjy.cn/1-163678809791839.png)图片插入
...
![img](http://blogimg.hongjy.cn/1-163678809791840.png)审查元素
...
![img](http://blogimg.hongjy.cn/1-163678809791941.jpeg)数字油画

#### HTML 标签

Typora 支持许多常用的 HTML 标签，如果你了解 HTML 语法的话，你可以写出十分美观丰富的文档页面。

![img](http://blogimg.hongjy.cn/1-163678809791942.png)HTML 标签
...
![img](http://blogimg.hongjy.cn/1-163678809791943.png)公众号
...
![img](http://blogimg.hongjy.cn/1-163678809791944.png)主题

![img](http://blogimg.hongjy.cn/1-163678809791945.png)主题文件夹

选择不同的主题可以使文档拥有不同的外观，但不会影响内容。Typora 自带了若干主题，你也可以在 [官网](http://theme.typora.io/) 下载更多的主题。

![img](http://blogimg.hongjy.cn/1-163678809791946.png)主题商店
...
![img](http://blogimg.hongjy.cn/1-163678809791947.png)CSS 文件
